                ...
                $.ajax({
                    ...
                    success: function (competitors) {
                        ...
                        competitors.forEach(competitor => {
                            const rankSuffix = competitor._rank == 1
                                ? 'st'
                                : competitor._rank == 2
                                ? 'nd'
                                : competitor._rank == 3
                            ...
                            const competitorHtml = `
                                <div class="details">
                                    <p>Place:</p>
                                    <p><strong>${competitor._rank ? competitor._rank + rankSuffix : 'N/A'}</strong></p>
                            ...
                            console.log(`Rank: ${competitor._rank}, Name: ${competitor.full_name}`);
